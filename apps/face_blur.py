...
from utils import resize_box, gauss_blur_face
...
def app():
    ...
    file = step_1.file_uploader("", type=['jpg'], on_change=to_upload_state)
    if file:
        img = Image.open(file)
    ...
    if step_2.button('Process', on_click=to_select_state):
